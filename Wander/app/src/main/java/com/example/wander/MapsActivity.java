...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private static final Object TAG = MapsActivity.class.getSimpleName();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng home = new LatLng(33.751079, -84.383537);
    ...
    private void setMapStyle(GoogleMap map) {
        try {
            ...
            if (!success) {
                Log.e((String) TAG, "Style parsing failed.");
            }
        } catch (Resources.NotFoundException e) {
            Log.e((String) TAG, "Can't find style. Error: ", e);
        }
    }
